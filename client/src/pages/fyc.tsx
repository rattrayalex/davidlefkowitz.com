            ...
            <div className="max-w-5xl mx-auto px-6">
                ...
                <div className="container mx-auto px-4" style={{ paddingTop: '16px' }}>
                    <div style={{
                        ...
                        <p className="mb-4">
                            A world premiere recording of works by award-winning contemporary composer <span style={{fontWeight: 'bold', color: '#DC143C'}}>David S. Lefkowitz</span>, <span style={{fontWeight: 'bold', color: '#A91C2C'}}>Preludes and Fugues for Piano</span> features 26 preludes and fugues performed by four leading new music pianists. Lefkowitz{'\u2019'}s huge musical palette is described as {'\u201C'}near-Mahlerian{'\u201D'} in this challenging and rewarding cycle that spans three hours. In the words of producer David Starobin, {'\u201C'}every once in a while a project comes by which seems so original that I am challenged to re-screw my ears on and such was the case with Lefkowitz{'\u2019'}s <span style={{fontWeight: 'bold', color: '#A91C2C'}}>Preludes and Fugues for Piano</span>.{'\u201D'} The album is now available on Bridge Records (9594A/B) and all leading streaming services. Lefkowitz presents his Preludes and Fugues in two books with Book 1, entitled Expanded Universe, and Book II, Parallel Universes.
                        </p>
