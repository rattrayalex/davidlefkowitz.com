                ...
                <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="space-y-8 mt-6">
                        ...
                        <div>
                            ...
                            <p className="text-xl text-gray-700 mb-2" data-testid="hero-title" style={{fontFamily: 'Times, "Times New Roman", Palatino, serif', fontWeight: '580'}}>
                                {profile?.title || "Composer, Professor of Music Composition & Theory"}
                            </p>
                            <p className="text-lg text-purple" data-testid="hero-institution" style={{fontFamily: 'Times, "Times New Roman", Palatino, serif', fontWeight: '580'}}>
