    ...
    return (
        <div className="min-h-screen">
            ...
            <section className="relative overflow-visible pt-16 pb-8" style={{backgroundColor: '#e5e5ff', minHeight: '800px'}}>
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2 flex items-center gap-8" style={{ bottom: '-60px' }}>
                    <a 
            ...
            <section className="pb-4" style={{backgroundColor: '#e5e5ff', paddingTop: '92px'}}>
                <div className="flex justify-center px-4">
                    <div style={{
                        ...
                        {/* Title */}
                        <h3 className="font-semibold my-4" style={{fontFamily: 'Times, "Times New Roman", Palatino, serif', fontSize: '1.75rem'}}>
