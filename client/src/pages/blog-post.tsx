            ...
            <section className="pt-3 pb-8">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="prose prose-lg max-w-none">
                        ...
                        <div className="text-gray-700 mb-6 p-6" data-testid="post-excerpt" style={{backgroundColor: 'white', fontFamily: 'Times, "Times New Roman", Palatino, serif', fontSize: '21px', lineHeight: '1.43', borderRadius: '0.5rem'}}>
